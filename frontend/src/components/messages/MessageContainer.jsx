import React, { useEffect } from "react"; // React kütüphanesini içe aktarır.
...
const MessageContainer = () => {
  // "MessageContainer" isminde bir fonksiyonel bileşen tanımlar.
  ...
  return (
    ...
    <div className="md:min-w-[450px] flex flex-col">
      ...
      {!selectedConversation ? ( // Eğer "noChatSelected" true ise, "NoChatSelected" bileşeni render edilir.
        <NoChatSelected />
      ) : (
