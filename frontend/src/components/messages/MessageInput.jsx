...
const MessageInput = () => { // "MessageInput" isminde bir fonksiyonel bileşen tanımlar.
  return (
    <form className="px-4 my-3"> {/* Form alanını oluşturur, çevresinde padding ekler */}
      <div className="w-full relative"> {/* Genişliği tam olarak kaplayan ve relative pozisyonlandırılmış bir div */}
        <input
